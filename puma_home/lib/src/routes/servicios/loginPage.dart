                ...
                onPressed: () async {
                   ...
                   */
                    ...
                    try {
                      ...
                      final userLoged = await _auth.signInWithEmailAndPassword(
                      ...
                      if (userLoged != null) {
                        ...
                        dbReference
                          ...
                          Map<String, dynamic> valor =
                              ds.data; //consultado un solo campo del Documento
                          if (valor['RolUser'] == 'student') {
                            //se verifica el rol del usuario y se decide a que pantalla accede y con que permisos
                      ...
                      if (errorcode == 'ERROR_WRONG_PASSWORD') {
                        ...
                        _errorDialog(
                            errorMessage); //cualquier otro mensaje de error va a aparecer aqui
                      }
                    }
                  }
                })),
